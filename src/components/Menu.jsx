    ...
    >
      <ul className="flex flex-col justify-center items-center gap-4 h-full font-bold text-2xl">
        <li onClick={handleMenuSlider}>
          <a
            className="hover:text-yellow-300 dark:hover:text-blue-600 border-b-2 border-b-transparent hover:border-b-slate-950 dark:hover:border-b-white transition-all"
            href="#home"
          >
            {t("eng.home")}
          </a>
        ...
        >
          <button className="hover:text-yellow-300 dark:hover:text-blue-600 border-b-2 border-b-transparent hover:border-b-slate-950 dark:hover:border-b-white transition-all">
            {t("eng.contact")}
          </button>
        </li>
      </ul>
